		...
		<div class="single_column_tokenomics">
				...
				<div class="tokenics_two_col_box">
					...
					<div class="tokenics_ico_txt">
						...
						<p class="white_title_tokenics">$STT stakers will have an influence on the crucial aspects of platform development such as staking yield etc.</p>
					</div>
				</div>
